...
def args_parser():
    ...
    # federated arguments
    parser.add_argument('--epochs', type=int, default=5,#200,
                        help="number of training epochs")
    parser.add_argument('--num_users', type=int, default=5,#20,
    ...
    parser.add_argument('--momentum', type=float, default=0.5,
                        help='SGD momentum')
    parser.add_argument('--train_rule', type=str, default='FedPAC',#default='FedAvg',
